...
main() async {
  ...
  const templates = [
    "maphero/android/src/main/java/com/mapbox/mapboxgl/LayerPropertyConverter.java",
    "maphero/ios/Classes/LayerPropertyConverter.swift",
    "maphero/lib/src/layer_expressions.dart",
    "maphero/lib/src/layer_properties.dart",
    "maphero_web/lib/src/layer_tools.dart",
    "maphero_platform_interface/lib/src/source_properties.dart",
  ];
