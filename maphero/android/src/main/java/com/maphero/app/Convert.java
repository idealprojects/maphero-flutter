...
/** Conversions between JSON-like values and MapHeroMaps data types. */
class Convert {
  ...
  static void interpretMapHeroMapOptions(Object o, MapHeroMapOptionsSink sink, Context context) {
