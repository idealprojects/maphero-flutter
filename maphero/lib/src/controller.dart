...
/// Controller for a single [MapHeroMap] instance running on the host platform.
///
...
///
/// 1. *Simple way to add annotations*: Use the corresponding add* methods ([addCircle], [addLine], [addSymbol] and [addFill]) on the MapHeroMapController to add one annotation at a time to the map.
...
///
/// A MapHeroMapController is also a [ChangeNotifier]. Subscribers (change listeners) are notified upon changes to any of
///
/// * the configuration options of the [MapHeroMap] widget
...
class MapHeroMapController extends ChangeNotifier {
  MapHeroMapController({
    required MapHeroPlatform mapheroPlatform,
    ...
    this.onCameraIdle,
  }) : _mapheroPlatform = mapheroPlatform {
    _cameraPosition = initialCameraPosition;

    _mapheroPlatform.onFeatureTappedPlatform.add((payload) {
      for (final fun
    ...
    _mapheroPlatform.onFeatureDraggedPlatform.add((payload) {
    ...
    _mapheroPlatform.onCameraMoveStartedPlatform.add((_) {
      _isCameraMoving = true;
      notifyListeners();
    });

    _mapheroPlatform.onCameraMovePlatform.add((cameraPosition) {
      _cameraPosition = cameraPosition;
      notifyListeners();
    });

    _mapheroPlatform.onCameraIdlePlatform.add((cameraPosition) {
    ...
    _mapheroPlatform.onMapStyleLoadedPlatform.add((_) {
    ...
    _mapheroPlatform.onMapClickPlatform.add((dict) {
      onMapClick?.call(dict['point'], dict['latLng']);
    });

    _mapheroPlatform.onMapLongClickPlatform.add((dict) {
      onMapLongClick?.call(dict['point'], dict['latLng']);
    });

    _mapheroPlatform.onCameraTrackingChangedPlatform.add((mode) {
      onCameraTrackingChanged?.call(mode);
    });

    _mapheroPlatform.onCameraTrackingDismissedPlatform.add((_) {
      onCameraTrackingDismissed?.call();
    });

    _mapheroPlatform.onMapIdlePlatform.add((_) {
      onMapIdle?.call();
    });
    _mapheroPlatform.onUserLocationUpdatedPlatform.add((location) {
  ...
  /// Will be null, if [MapHeroMap.trackCameraPosition] is false.
  CameraPosition? get cameraPosition => _cameraPosition;
  CameraPosition? _cameraPosition;

  final MapHeroPlatform _mapheroPlatform; //ignore: unused_field
  ...
  Future<void> _updateMapOptions(Map<String, dynamic> optionsUpdate) async {
    _cameraPosition = await _mapheroPlatform.updateMapOptions(optionsUpdate);
    notifyListeners();
  }
  ...
  Future<bool?> animateCamera(CameraUpdate cameraUpdate,
    ...
    return _mapheroPlatform.animateCamera(cameraUpdate, duration: duration);
  }
  ...
  Future<bool?> moveCamera(CameraUpdate cameraUpdate) async {
    return _mapheroPlatform.moveCamera(cameraUpdate);
  }
  ...
  Future<void> addGeoJsonSource(String sourceId, Map<String, dynamic> geojson,
    ...
    await _mapheroPlatform.addGeoJsonSource(sourceId, geojson,
        promoteId: promoteId);
  }
  ...
  Future<void> setGeoJsonSource(
    ...
    await _mapheroPlatform.setGeoJsonSource(sourceId, geojson);
  }
  ...
  Future<void> setGeoJsonFeature(
    ...
    await _mapheroPlatform.setFeatureForGeoJsonSource(
  ...
  Future<void> addSymbolLayer(
    ...
    await _mapheroPlatform.addSymbolLayer(
      sourceId,
      layerId,
      properties.toJson(),
  ...
  Future<void> addLineLayer(
      ...
      dynamic filter,
      bool enableInteraction = true}) async {
    await _mapheroPlatform.addLineLayer(
      sourceId,
      layerId,
      properties.toJson(),
      belowLayerId: belowLayerId,
  ...
  Future<void> setLayerProperties(
    ...
    await _mapheroPlatform.setLayerProperties(layerId, properties.toJson());
  }
  ...
  Future<void> addFillLayer(
      ...
      dynamic filter,
      bool enableInteraction = true}) async {
    await _mapheroPlatform.addFillLayer(
      sourceId,
      layerId,
      properties.toJson(),
      belowLayerId: belowLayerId,
  ...
  Future<void> addFillExtrusionLayer(
      ...
      dynamic filter,
      bool enableInteraction = true}) async {
    await _mapheroPlatform.addFillExtrusionLayer(
      sourceId,
      layerId,
      properties.toJson(),
      belowLayerId: belowLayerId,
  ...
  Future<void> addCircleLayer(
      ...
      dynamic filter,
      bool enableInteraction = true}) async {
    await _mapheroPlatform.addCircleLayer(
      sourceId,
      layerId,
      properties.toJson(),
      belowLayerId: belowLayerId,
  ...
  Future<void> addRasterLayer(
    ...
    await _mapheroPlatform.addRasterLayer(
      sourceId,
      layerId,
      properties.toJson(),
      belowLayerId: belowLayerId,
  ...
  Future<void> addHillshadeLayer(
      ...
      double? minzoom,
      double? maxzoom}) async {
    await _mapheroPlatform.addHillshadeLayer(
      sourceId,
      layerId,
      properties.toJson(),
      belowLayerId: belowLayerId,
  ...
  Future<void> addHeatmapLayer(
      ...
      double? minzoom,
      double? maxzoom}) async {
    await _mapheroPlatform.addHeatmapLayer(
      sourceId,
      layerId,
      properties.toJson(),
      belowLayerId: belowLayerId,
  ...
  Future<void> matchMapLanguageWithDeviceDefault() async {
    return _mapheroPlatform.matchMapLanguageWithDeviceDefault();
  }
  ...
  Future<void> updateContentInsets(EdgeInsets insets,
    ...
    return _mapheroPlatform.updateContentInsets(insets, animated);
  }
  ...
  Future<void> setMapLanguage(String language) async {
    return _mapheroPlatform.setMapLanguage(language);
  }
  ...
  Future<void> setTelemetryEnabled(bool enabled) async {
    return _mapheroPlatform.setTelemetryEnabled(enabled);
  }
  ...
  Future<bool> getTelemetryEnabled() async {
    return _mapheroPlatform.getTelemetryEnabled();
  }
  ...
  Future<List> queryRenderedFeatures(
    ...
    return _mapheroPlatform.queryRenderedFeatures(point, layerIds, filter);
  }

  /// Query rendered (i.e. visible) features in a Rect in screen coordinates
  Future<List> queryRenderedFeaturesInRect(
      Rect rect, List<String> layerIds, String? filter) async {
    return _mapheroPlatform.queryRenderedFeaturesInRect(
  ...
  Future<List> querySourceFeatures(
    ...
    return _mapheroPlatform.querySourceFeatures(
  ...
  Future<LatLng?> requestMyLocationLatLng() async {
    return _mapheroPlatform.requestMyLocationLatLng();
  }

  /// This method returns the boundaries of the region currently displayed in the map.
  Future<LatLngBounds> getVisibleRegion() async {
    return _mapheroPlatform.getVisibleRegion();
  }
  ...
  Future<void> addImage(String name, Uint8List bytes, [bool sdf = false]) {
    return _mapheroPlatform.addImage(name, bytes, sdf);
  }
  ...
  Future<void> addImageSource(
    ...
    return _mapheroPlatform.addImageSource(imageSourceId, bytes, coordinates);
  }
  ...
  Future<void> updateImageSource(
      String imageSourceId, Uint8List? bytes, LatLngQuad? coordinates) {
    return _mapheroPlatform.updateImageSource(
  ...
  Future<void> removeImageSource(String imageSourceId) {
    return _mapheroPlatform.removeSource(imageSourceId);
  }

  /// Removes previously added source by id
  Future<void> removeSource(String sourceId) {
    return _mapheroPlatform.removeSource(sourceId);
  }

  /// Adds an image layer to the map's style at render time.
  Future<void> addImageLayer(String layerId, String imageSourceId,
      {double? minzoom, double? maxzoom}) {
    return _mapheroPlatform.addLayer(layerId, imageSourceId, minzoom, maxzoom);
  }
  ...
  Future<void> addImageLayerBelow(
      ...
      {double? minzoom, double? maxzoom}) {
    return _mapheroPlatform.addLayerBelow(
  ...
  Future<void> removeLayer(String layerId) {
    return _mapheroPlatform.removeLayer(layerId);
  }

  Future<void> setFilter(String layerId, dynamic filter) {
    return _mapheroPlatform.setFilter(layerId, filter);
  }

  Future<dynamic> getFilter(String layerId) {
    return _mapheroPlatform.getFilter(layerId);
  }
  ...
  Future<Point> toScreenLocation(LatLng latLng) async {
    return _mapheroPlatform.toScreenLocation(latLng);
  }

  Future<List<Point>> toScreenLocationBatch(Iterable<LatLng> latLngs) async {
    return _mapheroPlatform.toScreenLocationBatch(latLngs);
  }
  ...
  Future<LatLng> toLatLng(Point screenLocation) async {
    return _mapheroPlatform.toLatLng(screenLocation);
  }

  /// Returns the distance spanned by one pixel at the specified [latitude] and current zoom level.
  /// The distance between pixels decreases as the latitude approaches the poles. This relationship parallels the relationship between longitudinal coordinates at different latitudes.
  Future<double> getMetersPerPixelAtLatitude(double latitude) async {
    return _mapheroPlatform.getMetersPerPixelAtLatitude(latitude);
  }

  /// Add a new source to the map
  Future<void> addSource(String sourceid, SourceProperties properties) async {
    return _mapheroPlatform.addSource(sourceid, properties);
  }
  ...
  Future setCameraBounds({
    ...
    return _mapheroPlatform.setCameraBounds(
      west: west,
      north: north,
      south: south,
      east: east,
  ...
  Future<void> setLayerVisibility(String layerId, bool visible) async {
    return _mapheroPlatform.setLayerVisibility(layerId, visible);
  }
  ...
  Future<List<String>> getSourceIds() async {
    return (await _mapheroPlatform.getSourceIds())
        .whereType<String>()
        .toList();
  }
