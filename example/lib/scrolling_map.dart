...
import 'package:maphero_example/util.dart';
...
class _ScrollingMapBodyState extends State<ScrollingMapBody> {
  late MapHeroMapController controllerOne;
  late MapHeroMapController controllerTwo;
  ...
  void onMapCreatedOne(MapHeroMapController controller) {
    controllerOne = controller;
  }

  void onMapCreatedTwo(MapHeroMapController controller) {
    controllerTwo = controller;
  }

  Future<void> onStyleLoaded(MapHeroMapController controller) async {
