...
class MapHeroMapController extends MapHeroPlatform
    implements MapHeroMapOptionsSink {
  late html.DivElement _mapElement;

  late Map<String, dynamic> _creationParams;
  late MapHeroMap _map;
  ...
  Widget buildView(
    ...
    return HtmlElementView(
        viewType: 'plugins.flutter.io/maphero_$hashCode');
  }
  ...
  void _registerViewFactory(Function(int) callback, int identifier) {
    ...
    ui.platformViewRegistry.registerViewFactory(
        'plugins.flutter.io/maphero_$identifier', (int viewId) {
  ...
  Future<CameraPosition?> updateMapOptions(
    ...
    Convert.interpretMapHeroMapOptions(optionsUpdate, this);
