...
import 'package:maphero_web/src/interop/geo/geojson_interop.dart';
import 'package:maphero_web/src/interop/geo/lng_lat_bounds_interop.dart';
import 'package:maphero_web/src/interop/geo/lng_lat_interop.dart';
import 'package:maphero_web/src/interop/geo/point_interop.dart';
import 'package:maphero_web/src/interop/style/style_interop.dart';
import 'package:maphero_web/src/interop/ui/camera_interop.dart';
import 'package:maphero_web/src/interop/ui/handler/box_zoom_interop.dart';
import 'package:maphero_web/src/interop/ui/handler/dblclick_zoom_interop.dart';
import 'package:maphero_web/src/interop/ui/handler/drag_pan_interop.dart';
import 'package:maphero_web/src/interop/ui/handler/drag_rotate_interop.dart';
import 'package:maphero_web/src/interop/ui/handler/keyboard_interop.dart';
import 'package:maphero_web/src/interop/ui/handler/scroll_zoom_interop.dart';
import 'package:maphero_web/src/interop/ui/handler/touch_zoom_rotate_interop.dart';
...
@JS('Map')
class MapHeroMapJsImpl extends CameraJsImpl {
  external factory MapHeroMapJsImpl(MapOptionsJsImpl options);
  ...
  external MapHeroMapJsImpl addControl(IControlJsImpl? control,
      [String? position]);
  ...
  external MapHeroMapJsImpl removeControl(IControlJsImpl? control);
  ...
  external MapHeroMapJsImpl resize([dynamic eventData]);
  ...
  external MapHeroMapJsImpl setMaxBounds(LngLatBoundsJsImpl? bounds);
  ...
  external MapHeroMapJsImpl setMinZoom([num? minZoom]);
  ...
  external MapHeroMapJsImpl setMaxZoom([num? maxZoom]);
  ...
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl setMinPitch([num? minPitch]);
  ...
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl setMaxPitch([num? maxPitch]);
  ...
  ///  @see [Render world copies](https://maplibre.org/maplibre-gl-js/docs/examples/render-world-copies/)
  external MapHeroMapJsImpl setRenderWorldCopies([bool? renderWorldCopies]);
  ...
  //external MapHeroMap on(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  ///  @returns {MapHeroMap} `this`
  // Defined in evented.dart
  //external MapHeroMap off(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  external MapHeroMapJsImpl setStyle(dynamic style, [dynamic options]);
  ...
  external MapHeroMapJsImpl addSource(String id, dynamic source);
  ...
  external MapHeroMapJsImpl addLayer(dynamic layer, [String? beforeId]);
  ...
  external MapHeroMapJsImpl moveLayer(String id, String beforeId);
  ...
  external MapHeroMapJsImpl setLayerZoomRange(
  ...
  external MapHeroMapJsImpl setFilter(String layerId, dynamic filter,
  ...
  external MapHeroMapJsImpl setLayoutProperty(
  ...
  ///  @param {boolean} [options.validate=true] Whether to check if the filter conforms to the MapLibre JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl setLight(
...
abstract class IControlJsImpl {
  ...
  ///  internally.
  external HtmlElement onAdd(MapHeroMapJsImpl map);

  ///  Unregister a control on the map and give it a chance to detach event listeners
  ///  and resources. This method is called by {@link MapHeroMap#removeControl}
  ///  internally.
  external onRemove(MapHeroMapJsImpl map);
