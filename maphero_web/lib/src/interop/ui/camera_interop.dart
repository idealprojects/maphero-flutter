...
import 'package:maphero_web/src/interop/util/evented_interop.dart';
...
abstract class CameraJsImpl extends EventedJsImpl {
  ...
  ///  @example
  ///  map.setCenter([-74, 38]);
  external MapHeroMapJsImpl setCenter(LngLatJsImpl center,
      [dynamic eventData]);
  ...
  external MapHeroMapJsImpl panBy(PointJsImpl offset,
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl panTo(LngLatJsImpl lnglat,
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  // zoom the map to 5
  ///  map.setZoom(5);
  external MapHeroMapJsImpl setZoom(num zoom, [dynamic eventData]);
  ...
  ///  @fires zoomend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl zoomTo(num zoom,
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires zoomend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl zoomIn(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires zoomend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl zoomOut(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  map.setBearing(90);
  external MapHeroMapJsImpl setBearing(num bearing, [dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl rotateTo(num bearing,
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl resetNorth(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl resetNorthPitch(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl snapToNorth(
      [AnimationOptionsJsImpl? options, dynamic eventData]);
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl setPitch(num pitch, [dynamic eventData]);
  ...
  external MapHeroMapJsImpl fitBounds(LngLatBoundsJsImpl bounds,
  ...
  external MapHeroMapJsImpl fitScreenCoordinates(
  ...
  ///  @fires pitchend
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl jumpTo(CameraOptionsJsImpl options,
      [dynamic eventData]);
  ...
  ///  @returns {MapHeroMap} `this`
  ///  @see [Navigate the map with game-like controls](https://maplibre.org/maplibre-gl-js/docs/examples/game-controls/)
  external MapHeroMapJsImpl easeTo(dynamic options, [dynamic eventData]);
  ...
  external MapHeroMapJsImpl flyTo(dynamic options, [dynamic eventData]);
  ...
  ///  @memberof MapHeroMap#
  ///  @returns {MapHeroMap} `this`
  external MapHeroMapJsImpl stop();
}
