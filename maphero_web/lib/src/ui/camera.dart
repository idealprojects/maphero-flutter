...
///  Options common to {@link MapHeroMap#jumpTo}, [MapHeroMap.easeTo], and {@link MapHeroMap#flyTo}, controlling the desired location,
...
///  Options common to map movement methods that involve animation, such as {@link MapHeroMap#panBy} and
///  [MapHeroMap.easeTo], controlling the duration and easing function of the animation. All properties
///  are optional.
///
...
///  Options for setting padding on a call to {@link MapHeroMap#fitBounds}. All properties of this object must be
...
class Camera extends Evented {
  ...
  ///  @example
  ///  map.setCenter([-74, 38]);
  MapHeroMap setCenter(LngLat center, [dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.setCenter(center.jsObject));
  ...
  MapHeroMap panBy(Point offset,
          [AnimationOptions? options, dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.panBy(offset.jsObject));
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap panTo(LngLat lnglat,
          [AnimationOptions? options, dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.panTo(lnglat.jsObject));
  ...
  ///  // zoom the map to 5
  ///  map.setZoom(5);
  MapHeroMap setZoom(num zoom, [dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.setZoom(zoom));
  ...
  ///  @fires zoomend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap zoomTo(num zoom,
          [AnimationOptions? options, dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.zoomTo(zoom));
  ...
  ///  @fires zoomend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap zoomIn([AnimationOptions? options, dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.zoomIn());
  ...
  ///  @fires zoomend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap zoomOut([AnimationOptions? options, dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.zoomOut());
  ...
  ///  map.setBearing(90);
  MapHeroMap setBearing(num bearing, [dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.setBearing(bearing));
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap rotateTo(num bearing,
          [AnimationOptions? options, dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.rotateTo(bearing));
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap resetNorth([AnimationOptions? options, dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.resetNorth());
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap resetNorthPitch([AnimationOptions? options, dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.resetNorthPitch());
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap snapToNorth([AnimationOptions? options, dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.snapToNorth());
  ...
  ///  @fires moveend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap setPitch(num pitch, [dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.setPitch(pitch));

  ///  @memberof MapHeroMap#
  ///  @param {LatLngBoundsLike} bounds Calculate the center for these bounds in the viewport and use
  ///       the highest zoom level up to and including `MapHeroMap#getMaxZoom()` that fits
  ...
  ///       zoom level up to and including `MapHeroMap#getMaxZoom()` that fits them in the viewport.
  ...
  ///      [MapHeroMap.easeTo]. If `false`, the map transitions using {@link MapHeroMap#flyTo}. See
  ...
  MapHeroMap fitBounds(LngLatBounds bounds,
  ...
  MapHeroMap fitScreenCoordinates(Point p0, Point p1, num bearing,
  ...
  ///  @fires pitchend
  ///  @returns {MapHeroMap} `this`
  MapHeroMap jumpTo(CameraOptions options, [dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.jumpTo(options.jsObject));
  ...
  ///  @returns {MapHeroMap} `this`
  ///  @see [Navigate the map with game-like controls](https://maplibre.org/maplibre-gl-js/docs/examples/game-controls/)
  MapHeroMap easeTo(dynamic options, [dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.easeTo(options));
  ...
  ///      value minimizes zooming for an effect closer to [MapHeroMap.easeTo]. 1.42 is the average
  ...
  MapHeroMap flyTo(dynamic options, [String? eventData]) =>
      MapHeroMap.fromJsObject(jsObject
  ...
  ///  @memberof MapHeroMap#
  ///  @returns {MapHeroMap} `this`
  MapHeroMap stop() => MapHeroMap.fromJsObject(jsObject.stop());
