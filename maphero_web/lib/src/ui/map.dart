...
import 'package:maphero_web/src/geo/point.dart';
import 'package:maphero_web/src/style/layers/layer.dart';
import 'package:maphero_web/src/style/sources/geojson_source.dart';
import 'package:maphero_web/src/style/sources/source.dart';
import 'package:maphero_web/src/style/sources/vector_source.dart';
import 'package:maphero_web/src/style/style.dart';
import 'package:maphero_web/src/ui/camera.dart';
import 'package:maphero_web/src/ui/handler/box_zoom.dart';
import 'package:maphero_web/src/ui/handler/dblclick_zoom.dart';
import 'package:maphero_web/src/ui/handler/drag_pan.dart';
import 'package:maphero_web/src/ui/handler/drag_rotate.dart';
import 'package:maphero_web/src/ui/handler/keyboard.dart';
import 'package:maphero_web/src/ui/handler/scroll_zoom.dart';
import 'package:maphero_web/src/ui/handler/touch_zoom_rotate.dart';

///  The `MapHeroMap` object represents the map on your page. It exposes methods
///  and properties that enable you to programmatically change the map,
///  and fires events as users interact with it.
///
///  You create a `MapHeroMap` by specifying a `container` and other options.
///  Then MapLibre JS JS initializes the map on the page and returns your `MapHeroMap`
///  object.
///
///  ```dart
///  var map = MapHeroMap(
...
///
class MapHeroMap extends Camera {
  @override
  final MapHeroMapJsImpl jsObject;


  factory MapHeroMap(MapOptions options) {
    return MapHeroMap.fromJsObject(MapHeroMapJsImpl(options.jsObject));
  }
  ...
  ///  @returns {MapHeroMap} `this`
  ///  @example
  ///  // Add zoom and rotation controls to the map.
  ///  map.addControl(new NavigationControl());
  ///  @see [Display map navigation controls](https://maplibre.org/maplibre-gl-js/docs/examples/navigation/)
  MapHeroMap addControl(dynamic control, [String? position]) {
    if (position != null) {
      return MapHeroMap.fromJsObject(
          jsObject.addControl(control.jsObject, position));
    }
    return MapHeroMap.fromJsObject(jsObject.addControl(control.jsObject));
  }
  ...
  MapHeroMap removeControl(dynamic control) =>
      MapHeroMap.fromJsObject(jsObject.removeControl(control.jsObject));
  ...
  MapHeroMap resize([dynamic eventData]) =>
      MapHeroMap.fromJsObject(jsObject.resize());
  ...
  MapHeroMap setMaxBounds(LngLatBounds? bounds) =>
      MapHeroMap.fromJsObject(jsObject.setMaxBounds(bounds?.jsObject));
  ...
  MapHeroMap setMinZoom([num? minZoom]) =>
      MapHeroMap.fromJsObject(jsObject.setMinZoom(minZoom));
  ...
  MapHeroMap setMaxZoom([num? maxZoom]) =>
      MapHeroMap.fromJsObject(jsObject.setMaxZoom(maxZoom));
  ...
  ///  @returns {MapHeroMap} `this`
  MapHeroMap setMinPitch([num? minPitch]) =>
      MapHeroMap.fromJsObject(jsObject.setMinPitch());
  ...
  ///  @returns {MapHeroMap} `this`
  MapHeroMap setMaxPitch([num? maxPitch]) =>
      MapHeroMap.fromJsObject(jsObject.setMaxPitch());
  ...
  ///  @see [Render world copies](https://maplibre.org/maplibre-gl-js/docs/examples/render-world-copies/)
  MapHeroMap setRenderWorldCopies([bool? renderWorldCopies]) =>
      MapHeroMap.fromJsObject(
  ...
  // MapHeroMap on(String type, [dynamic layerIdOrListener, Listener listener]);

  ///  Removes an event listener for layer-specific events previously added with `MapHeroMap#on`.
  ///
  ...
  ///  @returns {MapHeroMap} `this`
  // Defined in evented.dart
  // MapHeroMap off(String type, [dynamic layerIdOrListener, Listener listener]);
  ...
  ///  Omitting this parameter (i.e. calling [MapHeroMap.queryRenderedFeatures] with zero arguments,
  ...
  ///  [Feature objects](https://tools.ietf.org/html/rfc7946#section-3.2).
  ///
  ///  In contrast to [MapHeroMap.queryRenderedFeatures], this function returns all features matching the query parameters,
  ...
  MapHeroMap setStyle(dynamic style, [dynamic options]) =>
      MapHeroMap.fromJsObject(jsObject.setStyle(style));
  ...
  MapHeroMap addSource(String id, dynamic source) {
    if (source is Source) {
      return MapHeroMap.fromJsObject(jsObject.addSource(id, source.jsObject));
    }
    return MapHeroMap.fromJsObject(jsObject.addSource(id, jsify(source)));
  }
  ...
  ///  A {@link MapHeroMap#error} event will be fired if there is not enough space in the sprite to add this image.
  ///
  ...
  ///  Load an image from an external URL to be used with `MapHeroMap#addImage`. External
  ...
  MapHeroMap addLayer(dynamic layer, [String? beforeId]) {
    if (layer is Layer) {
      return MapHeroMap.fromJsObject(
          jsObject.addLayer(layer.jsObject, beforeId));
    }
    return MapHeroMap.fromJsObject(jsObject.addLayer(jsify(layer), beforeId));
  }
  ...
  MapHeroMap moveLayer(String id, String beforeId) =>
      MapHeroMap.fromJsObject(jsObject.moveLayer(id, beforeId));
  ...
  MapHeroMap setLayerZoomRange(String layerId, num minzoom, num maxzoom) =>
      MapHeroMap.fromJsObject(
  ...
  MapHeroMap setFilter(String layerId, dynamic filter,
          [StyleSetterOptions? options]) =>
      MapHeroMap.fromJsObject(jsObject.setFilter(layerId, filter));
  ...
  MapHeroMap setLayoutProperty(String layerId, String name, dynamic value,
          [StyleSetterOptions? options]) =>
      MapHeroMap.fromJsObject(
  ...
  ///  @param {boolean} [options.validate=true] Whether to check if the filter conforms to the MapLibre JS Style Specification. Disabling validation is a performance optimization that should only be used if you have previously validated the values you will be passing to this function.
  ///  @returns {MapHeroMap} `this`
  MapHeroMap setLight(dynamic light, StyleSetterOptions options) =>
      MapHeroMap.fromJsObject(jsObject.setLight(light, options.jsObject));
  ...
  ///  [MapHeroMap.queryRenderedFeatures] or event handlers can be used as feature identifiers.
  ...
  ///  Feature objects returned from [MapHeroMap.queryRenderedFeatures] or event handlers can be used as feature identifiers.
  ...
  /// Creates a new MapHeroMap from a [jsObject].
  MapHeroMap.fromJsObject(this.jsObject) : super.fromJsObject(jsObject);
}
...
class MapOptions extends JsObjectWrapper<MapOptionsJsImpl> {
  ...
  /// A callback run before the MapHeroMap makes a request for an external URL. The callback can be used to modify the url, set headers, or set the credentials property for cross-origin requests.
...
///
///   @override
///   HtmlElement onAdd(MapHeroMap map) {
...
class IControl extends JsObjectWrapper<IControlJsImpl> {
  ...
  ///  and resources. This method is called by {@link MapHeroMap#addControl}
  ///  internally.
  HtmlElement onAdd(MapHeroMap map) => jsObject.onAdd(map.jsObject);

  ///  Unregister a control on the map and give it a chance to detach event listeners
  ///  and resources. This method is called by {@link MapHeroMap#removeControl}
  ///  internally.
  onRemove(MapHeroMap map) => jsObject.onRemove(map.jsObject);

  ///  Optionally provide a default position for this control. If this method
  ///  is implemented and {@link MapHeroMap#addControl} is called without the `position`
